...
export const Products : CollectionConfig = {
    ...
    fields: [
        ...
        },
        {
            ...
            admin: {
                description: "Введите до 10 ключевых слов или фраз (синонимы, популярные варианты запросов), которые помогут пользователям найти эту услугу через поиск на сайте."
            }
        },
        {
